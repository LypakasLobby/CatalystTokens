...
import com.lypaka.bettertokens.GUIs.CommonButtons;
    ...
    public void openMenu (ServerPlayerEntity player) throws ObjectMappingException {
        ...
        for (Map.Entry<String, Map<String, String>> entry : this.slotsMap.entrySet()) {
            ...
            if (ConfigGetters.canBuy(player, price)) {
                ...
                List<String> commands = BetterTokens.menuConfigManager.getConfigNode(index, "Slots", entry.getKey(), "Redeems").getList(TypeToken.of(String.class));
